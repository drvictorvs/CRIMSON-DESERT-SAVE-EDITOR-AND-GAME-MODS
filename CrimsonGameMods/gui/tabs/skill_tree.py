...
class SkillTreeTab(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self._btn_swap_export.setStyleSheet("background-color: #0277BD; color: white; font-weight: bold;")
    ...
    def _on_skill_export_json(self) -> None:
        ...
        default_name = "SkillInfo.field.json"
        path, _ = QFileDialog.getSaveFileName(
